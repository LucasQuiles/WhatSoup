...
src/
  ...
  mcp/            Tool registry (164 documented tools; 161 always registered + 3 conditional), Unix socket server, 21 tool modules
  runtimes/
...
| [MCP Tool Reference](docs/tools.md) | All 164 tools across 21 documented modules plus the inline runtime tool, with scopes, parameters, replay policies |
