...
| [MCP Tool Reference](docs/tools.md) | All 167 tools across 21 documented modules plus the inline runtime tool, with scopes, parameters, replay policies |
