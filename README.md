...
One process per instance. One SQLite database per instance. 161 MCP tools (160 always-registered + `knowledge_search` registered only when Pinecone is configured). No build step. Probably too many MCP tools.
