...
export const config = {
  ...
  // the user once per recovery. 0 restores the legacy immediate send.
  startupNotificationStabilitySeconds: Math.max(0, numberProp(instance ?? undefined, 'startupNotificationStabilitySeconds', 600)),
