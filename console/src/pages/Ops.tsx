    ...
    >
      ...
      >
        ...
        >
          ...
          {alerts.length > 0 ? (
            <span className="flex items-center font-mono text-s-crit text-[var(--font-size-label)] gap-[var(--sp-1)]">
              <AlertTriangle size={12} strokeWidth={1.75} />
              {alerts.length} alert{alerts.length !== 1 ? 's' : ''}
            </span>
          ) : (
            <span className="flex items-center font-mono text-s-ok text-[var(--font-size-label)] gap-[var(--sp-1)]">
            ...
            {linesLoading ? (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center font-mono text-t4 text-[var(--font-size-sm)] gap-[var(--sp-3)]">
                ...
                {line.status !== 'online' && (
                  <div className="flex gap-[var(--sp-2)] mt-[var(--sp-3)] pt-[var(--sp-3)] c-border-b">
                    ...
                    <button
                      type="button"
                      className="c-btn py-[var(--sp-1)] px-[var(--sp-3)] text-[var(--font-size-label)] text-s-crit"
      ...
      >
          ...
          {filteredLogs.length > 0 ? (
            filteredLogs.map((log: LogEntry, i: number) => (
              ...
              >
                {/* Timestamp */}
                <div
                  className="flex-shrink-0 text-t5 py-[var(--sp-2)] px-[var(--sp-3)] border-r border-solid border-[var(--b1)] w-[var(--log-col-time)]"
                >
                  {formatTimeWithSeconds(log.timestamp)}
                </div>
                {/* Level badge */}
                <div
                  className="flex-shrink-0 text-center py-[var(--sp-2)] border-r border-solid border-[var(--b1)] w-[var(--log-col-level)]"
                >
                  <span
                ...
                {/* Source */}
                <div
                  className="flex-shrink-0 text-t5 truncate py-0 px-[var(--sp-2)] border-r border-solid border-[var(--b1)] w-[var(--log-col-source)]"
                >
                  {log.source}
                </div>
                {/* Message */}
                <div className={`flex-1 ${levelColor[log.level]} py-[var(--sp-2)] px-[var(--sp-3)]`}>
                  {log.msg}
                </div>
              </div>
            ))
        ...
        {/* Status bar */}
        <div
          className="flex items-center justify-between flex-shrink-0 font-mono text-t5 text-[var(--font-size-xs)] py-[var(--sp-1)] px-[var(--sp-4)] c-border-b bg-d1"
        >
