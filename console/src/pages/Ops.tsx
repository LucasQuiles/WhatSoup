  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col gap-[var(--sp-2)]">
            {linesLoading ? (
              ...
              >
                ...
                {line.status !== 'online' && (
                  <div className="flex gap-[var(--sp-2)] mt-[var(--sp-3)] pt-[var(--sp-3)] border-t border-solid border-[var(--b1)]">
      ...
      >
          ...
          {filteredLogs.length > 0 ? (
            filteredLogs.map((log: LogEntry, i: number) => (
              ...
              >
                {/* Timestamp */}
                <div
                  className="flex-shrink-0 text-t5 w-[var(--log-col-time)] py-[var(--sp-2)] px-[var(--sp-3)] border-r border-solid border-[var(--b1)]"
                >
                  {formatTimeWithSeconds(log.timestamp)}
                </div>
                {/* Level badge */}
                <div
                  className="flex-shrink-0 text-center w-[var(--log-col-level)] py-[var(--sp-2)] border-r border-solid border-[var(--b1)]"
                >
                  <span
                ...
                {/* Source */}
                <div
                  className="flex-shrink-0 text-t5 truncate w-[var(--log-col-source)] py-[var(--sp-2)] px-[var(--sp-2)] border-r border-solid border-[var(--b1)]"
                >
                  {log.source}
                </div>
                {/* Message */}
        ...
        {/* Status bar */}
        <div
          className="flex items-center justify-between flex-shrink-0 font-mono text-t5 text-[var(--font-size-xs)] py-[var(--sp-1h)] px-[var(--sp-4)] border-t border-solid border-[var(--b1)] bg-d1"
        >
