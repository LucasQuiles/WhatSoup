...
export default function LineDetail() {
  ...
  return (
    ...
    >
      {/* ═══ Line Header ═══ */}
      <div
        className="flex items-center gap-4 c-toolbar flex-shrink-0 bg-d2 border border-solid border-[var(--b1)] rounded-lg"
      >
        <button
          type="button"
          onClick={() => navigate('/')}
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h1 className="text-t1 font-extrabold font-sans text-[var(--font-size-xl)] tracking-[var(--tracking-tight)]">
              {line.name}
            </h1>
        ...
        <div className="flex items-center gap-[var(--sp-2)]">
          ...
          <button
            ...
            className="c-btn c-btn-ghost text-[var(--font-size-label)] text-s-crit"
          >
      ...
      <div
        className="flex-1 flex flex-col min-h-0 bg-d1 border border-solid border-[var(--b1)] rounded-lg overflow-hidden"
      >
      <div
        ...
        {tabs.map(tab => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 font-sans font-medium c-hover relative py-[var(--sp-2)] px-[var(--sp-4)] text-[var(--font-size-data)] ${
                isActive
            ...
            >
              ...
              {isActive && (
                <div
                  className="absolute bottom-0 left-2 right-2 rounded-t h-[var(--bw-accent)]"
