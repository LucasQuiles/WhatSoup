...
export default function LineDetail() {
  ...
  return (
    ...
    >
      {/* ═══ Line Header ═══ */}
      <div
        className="flex items-center gap-4 c-toolbar flex-shrink-0 bg-d2 border border-[var(--b1)] rounded-lg"
        style={{}}
      >
        <button
          type="button"
      ...
      <div
        className="flex-1 flex flex-col min-h-0 bg-d1 border border-[var(--b1)] rounded-lg overflow-hidden"
      >
      <div
