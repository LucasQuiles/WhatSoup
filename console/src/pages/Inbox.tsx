        ...
        {selectedChat && currentChat ? (
          <>
            ...
            >
              <textarea
                ref={textareaRef}
                className="flex-1 text-t2 font-sans placeholder-t5 outline-none leading-tight text-[var(--font-size-body)] py-[var(--sp-2h)] px-[var(--sp-4)] bg-d1 border-[var(--bw)] border-solid border-[var(--b2)] rounded-md"
                rows={1}
                style={{
                ...
                onChange={e => {
                  ...
                  const el = e.target
                  const maxH = parseInt(getComputedStyle(el).getPropertyValue('--feed-preview-max'))
                  el.style.height = '0'
          ...
          <>
            ...
            <div className="flex-1 overflow-auto scrollbar-hide p-[var(--sp-4)]">
              ...
              <div className="mb-[var(--sp-4)]">
                ...
                <div
                  className="bg-d2 border-[var(--bw)] border-solid border-[var(--b1)] rounded-md py-[var(--sp-3)] px-[var(--sp-4)]"
                >
                  {[
                    ...
                    <div
                      key={item.label}
                      className={`flex justify-between py-[var(--sp-2)] px-0 ${i < arr.length - 1 ? 'border-b-[var(--bw)] border-b-solid border-b-[var(--b1)]' : ''}`}
                    >
