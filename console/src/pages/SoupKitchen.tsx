...
const COLUMNS: { label: string; widthClass?: string; center: boolean; sortKey: SortKey }[] = [
  { label: "Mode", widthClass: "w-[var(--col-mode)]", center: false, sortKey: "mode" },
  { label: "Line", center: false, sortKey: "name" },
  { label: "Chats", widthClass: "w-[var(--col-chats)]", center: true, sortKey: "chats" },
  { label: "Groups", widthClass: "w-[var(--col-groups)]", center: true, sortKey: "groups" },
  { label: "Unread", widthClass: "w-[var(--col-unread)]", center: true, sortKey: "unread" },
  { label: "Sent", widthClass: "w-[var(--col-sent)]", center: true, sortKey: "sent" },
  { label: "Recv", widthClass: "w-[var(--col-recv)]", center: true, sortKey: "recv" },
  { label: "Tokens", widthClass: "w-[var(--col-tokens)]", center: true, sortKey: "tokens" },
  { label: "Sessions", widthClass: "w-[var(--col-sessions)]", center: true, sortKey: "sessions" },
  { label: "Tags", center: false, sortKey: null },
  { label: "Active", widthClass: "w-[var(--col-active)]", center: true, sortKey: "active" },
];
