...
export type { Mode, Status, LineInstance, ChatItem, Message, AccessEntry, LogEntry, FeedEvent } from './types';
import type { Mode, LineInstance, ChatItem, Message, AccessEntry, LogEntry, FeedEvent } from './types';
...
export const MOCK_LINES: LineInstance[] = [
  ...
  },
  {
    ...
    unread: 23,
    messagesToday: 466,
    messageStats: { sent: 189, received: 277, images: 15, audio: 2, documents: 8 },
    totalSessions: 0,
    models: null,
    sandboxPerChat: false,
    chatCounts: { chats: 31, groups: 5 },
    tokenUsage: { input: 0, output: 0 },
  },
  {
    name: 'backup',
    ...
    unread: 24,
    messagesToday: 205,
    messageStats: { sent: 78, received: 127, images: 9, audio: 0, documents: 1 },
    totalSessions: 0,
    models: null,
    sandboxPerChat: false,
    chatCounts: { chats: 18, groups: 3 },
    tokenUsage: { input: 0, output: 0 },
  },
  {
    name: 'besbot',
    ...
    messagesToday: 2520,
    messageStats: { sent: 1180, received: 1340, images: 12, audio: 0, documents: 45 },
    totalSessions: 0,
    models: { conversation: 'claude-sonnet-4-6', fallback: 'gpt-5.4', extraction: 'claude-haiku-4-5', validation: 'claude-haiku-4-5' },
    sandboxPerChat: false,
    chatCounts: { chats: 89, groups: 12 },
    tokenUsage: { input: 2_450_000, output: 890_000 },
  },
  {
    name: 'salesbot',
    phone: '+1 555-0201',
    ...
    enrichmentUnprocessed: 0,
    messagesToday: 967,
    messageStats: { sent: 490, received: 477, images: 3, audio: 0, documents: 22 },
    totalSessions: 0,
    models: { conversation: 'gpt-5.4', extraction: 'claude-haiku-4-5', validation: 'claude-haiku-4-5' },
    sandboxPerChat: false,
    chatCounts: { chats: 56, groups: 4 },
    tokenUsage: { input: 1_120_000, output: 430_000 },
  },
  {
    name: 'q-agent',
    phone: '+1 555-0202',
    ...
    lastSessionStatus: 'running',
    messagesToday: 567,
    messageStats: { sent: 234, received: 333, images: 5, audio: 0, documents: 12 },
    totalSessions: 47,
    models: { conversation: 'claude-opus-4-6', extraction: 'claude-sonnet-4-6', validation: 'claude-haiku-4-5' },
    sandboxPerChat: false,
    chatCounts: { chats: 23, groups: 2 },
    tokenUsage: { input: 8_750_000, output: 3_200_000 },
  },
  {
    name: 'alex',
    phone: '+44 7700-0300',
    ...
    unread: 0,
    messagesToday: 115,
    messageStats: { sent: 42, received: 73, images: 6, audio: 1, documents: 0 },
    totalSessions: 0,
    models: null,
    sandboxPerChat: false,
    chatCounts: { chats: 15, groups: 2 },
    tokenUsage: { input: 0, output: 0 },
  },
  {
    name: 'loops',
    ...
    models: { conversation: 'claude-opus-4-6', extraction: 'claude-sonnet-4-6', validation: 'claude-haiku-4-5' },
    sandboxPerChat: true,
    chatCounts: { chats: 45, groups: 0 },
    tokenUsage: { input: 15_200_000, output: 5_800_000 },
  },
  {
    name: 'jordan',
    phone: '+44 7700-0302',
    ...
    enrichmentUnprocessed: 0,
    messagesToday: 594,
    messageStats: { sent: 287, received: 307, images: 8, audio: 0, documents: 14 },
    totalSessions: 0,
    models: { conversation: 'claude-sonnet-4-6', fallback: 'gpt-5.4', extraction: 'claude-haiku-4-5', validation: 'claude-haiku-4-5' },
    sandboxPerChat: false,
    chatCounts: { chats: 34, groups: 7 },
    tokenUsage: { input: 1_890_000, output: 720_000 },
  },
  {
    name: 'devbot',
    phone: '+1 555-0203',
    ...
    messagesToday: 176,
    messageStats: { sent: 88, received: 88, images: 2, audio: 0, documents: 5 },
    totalSessions: 0,
    models: { conversation: 'claude-sonnet-4-6', extraction: 'claude-haiku-4-5', validation: 'claude-haiku-4-5' },
    sandboxPerChat: false,
    chatCounts: { chats: 12, groups: 3 },
    tokenUsage: { input: 680_000, output: 245_000 },
  },
  {
    name: 'lucy',
    phone: '+44 7700-0303',
    ...
    unread: 12,
    messagesToday: 170,
    messageStats: { sent: 65, received: 105, images: 12, audio: 3, documents: 0 },
    totalSessions: 0,
    models: null,
    sandboxPerChat: false,
    chatCounts: { chats: 22, groups: 4 },
    tokenUsage: { input: 0, output: 0 },
  },
];
