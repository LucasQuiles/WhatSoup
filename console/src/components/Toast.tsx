...
const Toast: FC<ToastProps> = ({ variant, message, onClose, duration = 4000 }) => {
  ...
  return (
    <div
      role="alert"
      aria-live="polite"
      className="flex items-center gap-2.5 font-medium py-[var(--sp-2h)] px-[var(--sp-4)] rounded-md text-[var(--font-size-body)] bg-d3 shadow-[var(--shadow-md)] max-w-[var(--toast-max-w)]"
      style={{
