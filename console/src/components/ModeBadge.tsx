...
const ModeBadge: FC<ModeBadgeProps> = ({ mode }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 font-mono font-medium text-[var(--font-size-label)] tracking-[var(--tracking-pill)] py-[var(--sp-0h)] px-[var(--sp-2h)] rounded-sm ${textClass}`}
      style={{
