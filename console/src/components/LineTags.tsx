...
const Tag: FC<{ tag: TagDef }> = ({ tag }) => {
  ...
  return (
    <span
      className="inline-flex items-center font-mono font-medium text-[var(--font-size-xs)] tracking-[var(--tracking-pill)] py-[var(--bw)] px-[var(--sp-1h)] rounded-sm gap-[var(--sp-0h)] whitespace-nowrap"
      style={{
        color: tag.color,
