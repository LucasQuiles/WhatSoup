  ...
  return (
    ...
    >
      <div
        ...
        className="wizard-accent-scope bg-d2 c-border rounded-lg shadow-[var(--shadow-lg)] flex flex-col overflow-hidden w-[var(--panel-wizard)] max-w-[90%] min-h-[var(--modal-min-h)] h-[var(--modal-max-h)] max-h-[var(--modal-max-h)]"
        style={{
