    ...
    {steps.map((label, i) => {
      ...
      return (
        <div key={label} className="flex items-center gap-[var(--sp-1)]">
          {i > 0 && (
            <div
              className="h-[var(--bw)] w-[var(--stepper-line-w)]"
              style={{
          ...
          <div className="flex flex-col items-center gap-[var(--sp-1)]">
            ...
            >
              {completed ? (
                ...
                <div
                  className="rounded-full w-[var(--stepper-dot)] h-[var(--stepper-dot)]"
                  style={{
  ...
  return (
    ...
    >
      <div
        ...
        className="wizard-accent-scope w-[var(--panel-wizard)] min-w-[var(--panel-wizard)] max-w-[90%] min-h-[var(--modal-min-h)] h-[var(--modal-max-h)] max-h-[var(--modal-max-h)] bg-d2 border border-[var(--b2)] rounded-lg shadow-[var(--shadow-lg)] flex flex-col overflow-hidden"
        style={{
      ...
      >
        ...
        >
          ...
          <button onClick={handleClose} aria-label="Close wizard" type="button" className="c-btn c-btn-ghost">
            <X size={16} />
          </button>
        </div>
        ...
        {currentStep !== 1 && (
          ...
          >
            {createError && (
              <div
                className="flex items-center gap-[var(--sp-2)] py-[var(--sp-2)] px-[var(--sp-3)] text-[var(--font-size-data)] text-s-crit bg-d3 rounded-sm"
              >
