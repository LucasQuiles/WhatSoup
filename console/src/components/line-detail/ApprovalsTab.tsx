 ...
 * the SAME path a WhatsApp vote takes (UX-20 parity). Console button,
 ...
 * with the WhatsApp-lane note (v1). Fail-closed: a fleet read error
      ...
      >
        {pendingDecision && (
          <>
            ...
            poll-resolution path a WhatsApp vote takes — if it was already answered
