...
export function MetricsTab({
  ...
  return (
    <div className="flex-1 overflow-auto px-[var(--sp-4)] py-[var(--sp-5)]">
      {/* Range selector */}
      ...
      {metricsLoading ? (
        ...
        <div className="flex flex-col gap-[var(--sp-4)]">
          ...
          {line?.tokenUsage && (line.tokenUsage.input > 0 || line.tokenUsage.output > 0) && (
            ...
            >
              <div
                className="font-mono text-t4 mb-[var(--sp-3)] uppercase text-[var(--font-size-xs)] tracking-[var(--tracking-label)]"
              >
                Token Usage
              </div>
