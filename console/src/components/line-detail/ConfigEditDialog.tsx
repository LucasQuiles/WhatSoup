  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Restart warning */}
        <div
          className="flex items-center gap-2 flex-shrink-0 py-[var(--sp-3)] px-[var(--sp-5)] bg-[var(--s-warn-wash)] c-border-b text-[var(--font-size-sm)] text-s-warn"
        >
              ...
              <div key={key}>
                <label className="c-label block mb-[var(--sp-1)]">
                  ...
                  {(key in patch || key in customEnumFields) && (
                    <span
                      className="font-mono ml-[var(--sp-2)] text-[var(--font-size-xs)] text-s-warn"
                    >
                      modified
                    </span>
                  )}
                ...
                {(key in patch || key in customEnumFields) && getFieldError(key) && (
                  <span className="font-mono text-[var(--font-size-xs)] text-s-crit mt-[var(--sp-1)] block">
                    {getFieldError(key)}
                  </span>
                )}
              </div>
