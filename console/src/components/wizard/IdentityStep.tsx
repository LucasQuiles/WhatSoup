      ...
      <div>
        ...
        <div className="flex items-center gap-[var(--sp-2)]">
          <input
            ...
            placeholder="my-line"
            className={`font-mono ${nameLocked ? 'cursor-not-allowed' : ''}`}
            disabled={nameLocked}
            style={{
              ...inputStyle,
