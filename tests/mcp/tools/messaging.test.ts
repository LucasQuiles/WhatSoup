...
describe('registerMessagingTools', () => {
  ...
  describe('send_message', () => {
    ...
    it('suppresses one-line no-action acknowledgment filler without sending transport', async () => {
      const session = chatSession('main-chat', 'main-chat@s.whatsapp.net');
      const result = await registry.call('send_message', { text: 'No action.' }, session);
    ...
    it('suppresses meta-silence acknowledgment filler without sending transport', async () => {
      ...
      const result = await registry.call(
        'send_message',
        { text: 'No action needed — staying silent per directive.' },
        session,
      );
    ...
    it('suppresses no-acknowledgement-needed acknowledgment filler without sending transport', async () => {
      const session = chatSession('main-chat', 'main-chat@s.whatsapp.net');
      const result = await registry.call(
        'send_message',
        { text: 'No acknowledgement needed — staying silent.' },
        session,
      );
    ...
    it('suppresses standing-by status acknowledgment filler without sending transport', async () => {
      ...
      const result = await registry.call(
        'send_message',
        {
          text: 'No action needed — LCP stays parked on QB Time/TSheets auth; no user ask pending. Standing by.',
        },
        session,
      );
