...
const SCOPE_MAP: Record<string, ScopeEntry> = {
  ...
  'sql-schema': { class: 'probe-refuse', reason: 'walks cwd/src (or --root) for SQL literals (#3610); refuses "examined 0 source file(s)" and a scan that found 0 SQL literals outside the allow-list', probe: { via: 'cwd' } },
