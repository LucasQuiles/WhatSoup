...
Consolidated WhatsApp platform — one process, one Baileys connection, one database, and an MCP tool registry documented in `docs/tools.md`.
...
- `docs/tools.md` — complete MCP tool API reference generated from the tool registry and inline runtime registrations
