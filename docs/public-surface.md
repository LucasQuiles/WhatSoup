...
| `http:fleet.silences.add` | `POST /api/fleet/silence` | `src/fleet/index.ts:330` | beta | active | Add a silence rule (instance, duration). Persisted under `~/.config/whatsoup/fleet-silences.json`. |
