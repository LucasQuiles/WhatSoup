...
all 166 tools (163 always-registered + 3 conditionally-registered: `knowledge_search` when
...
> The conditional `emit_heal_result` tool is registered inline from
