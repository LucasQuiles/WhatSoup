...
| `cli:npm.preflight-instructions-path` | `npm run preflight:instructions-path` | `package.json` | alpha | active | Fail-closed instance agent-instructions path validation (salvaged fleet-runtime guard; blocks on unresolvable/world-writable/out-of-tree instruction paths) |
