...
| `http:health.agent-compact` | `POST /agent/compact` | `src/core/health.ts:1314` | stable | active | Out-of-band compaction; requires `chatJid` for per-chat / shared scopes |
