...
| `cli:npm.guard-png-estate-staged` | `npm run guard:png-estate:staged` | `package.json` | stable | active | Pre-commit half of the png-estate policy: reject any staged PNG under artifacts/ (untracked by policy) and any staged new/changed PNG over 100 KB (compress or host externally) |
