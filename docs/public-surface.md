...
| `http:health.mark-read` | `POST /mark-read` | `src/core/health.ts:1133` | stable | active | Zero unread + chatModify |
| `http:health.typing` | `GET /typing` | `src/core/health.ts:1203` | stable | active | Currently-composing JIDs from presence cache |
