...
| `config:instance_config.agentOptions.additionalMcpServers` | config-key | [docs/configuration.md §agentOptions.additionalMcpServers](configuration.md#agentoptionsadditionalmcpservers) | v1 (bootstrap) | stable | active | Instance-declared MCP servers (keyring-backed env, fail-closed surface assertion) |
