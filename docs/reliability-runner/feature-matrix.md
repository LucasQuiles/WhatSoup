...
The fresh provider-hardening compose branch `integration/provider-hardening-compose-refresh-20260613T194657Z` at `6dcae2ea` passed targeted TS tests (612/612 before final cherry-proof; 239/239 for the two rescued branch tips), deploy Python pytest (302/302), changed-test Test Integrity, `guard:test-integrity`, static/doc/publication/runtime-manifest guards, runtime trace warning check (216/216, no `TimeoutNaNWarning`/`NaN` hits), full Vitest (590 files passed / 2 skipped; 9591 tests passed / 11 skipped), and `verify:push:branch`.
