...
| RR-011 | TRIAGED | Artifact sweep consolidation and objective hygiene | 40% | `.sweep/20260613T040537Z/manifest.md`; instruction audit output | Apply or explicitly defer artifact/memory cleanup with user approval; tracked docs must not depend on ignored local artifacts. |
