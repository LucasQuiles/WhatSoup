...
(Append one line per merged phase PR. For Phase B, append one line per accepted provider PR because that phase intentionally ships one provider boundary per PR.)

- 2026-05-09 — kickoff doc + finding doc on branch `docs/security-handoff-env-secrets-20260509`; PR not yet opened.
- 2026-05-11 — kickoff + finding docs merged via PR #199 at SHA `9493012c`.
