...
The current enforced inventory is 10 total findings: 10 consumer migrations and 0 primitive
self-hits, with an element split of 6 inputs, 1 select, and 3 textareas. The former 5
...
by routing its reply composer through `TextArea`.
