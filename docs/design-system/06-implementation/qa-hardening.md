...
The current enforced inventory is 17 total findings: 17 consumer migrations and 0 primitive
self-hits, with an element split of 10 inputs, 1 select, and 6 textareas. The former 5
...
subject/description/ephemeral controls through the promoted primitives.
