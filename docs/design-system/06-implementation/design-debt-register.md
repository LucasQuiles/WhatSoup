...
| DD-15 | Segmented controls — REMAINING binary c-btn toggle pairs in GroupDetailModal/ScheduleComposerModal after B2 adopted ToolbarTimeRange for both time-range segs | component | component | P3 | dialog surfaces not yet migrated | c-btn toggles | B3 waves 2-3 migrate the dialogs and their toggles | C3 | all segmented sites on the canonical seg | no |
