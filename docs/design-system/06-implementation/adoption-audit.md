...
## 5. Shadow-baseline rollup (ground truth: console/lint-shadow-baseline.json, total 48)

| Rule | Falls | Files | Top files |
|---|---|---|---|
| soup/no-legacy-tokens | 27 | 2 | Nav 15 · UpdateModal 12 (both gated to the P4/C4 brand slice; pages + wizard + shared + App surfaces fully migrated) |
...
Reconciliation: the live shadow baseline is 48 (= 27 + 18 + 2 + 1) and the live
