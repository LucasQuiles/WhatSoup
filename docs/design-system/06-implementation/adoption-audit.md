...
## 5. Shadow-baseline rollup (ground truth: console/lint-shadow-baseline.json, total 299)

| Rule | Falls | Files | Top files |
|---|---|---|---|
| soup/no-legacy-tokens | 278 | 53 | GroupDetailModal 16 · SummaryTab 16 · ActiveHoursHeatmap 15 · MessageContent 15 · Nav 15 · MetricsTab 13 · UpdateModal 12 · AccessTab 9 · HistoryTab 9 · (44 more files, full list in `console/lint-shadow-baseline.json`) |
...
Reconciliation: the live shadow baseline is 299 (= 278 + 18 + 2 + 1) and the live
