...
**Home:** branch `design/soup-v35` + worktree `.worktrees/soup-v35-design` created in
`~/LAB/WhatSoup` (A1). Repo file migration blocked by this session's external-dir write
sandbox; SSOT until then: `~/agents/q/docs/design-v35/` (git-tracked, commit fd0f994).
