...
- **Steps:**
  ...
  - [ ] Extend the existing deploy preflight/cutover path and managed compatibility
    ...
    runtime artifact, it proves that artifact is v46 write-compatible; otherwise it
  ...
  - [ ] Document receipt inspection, quarantine/tombstone meaning, replay veto,
    ...
    downgrade to be fully v46 write-compatible or drain/read-only with all new
