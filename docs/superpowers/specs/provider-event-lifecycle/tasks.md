...
2. Schema-lineage canonicalization is merged through PR #1768
   ...
   verification and later fleet verification before schema 46.
...
- **Steps:**
  ...
  - [x] Restore the exact final historical migration-41 source and the exact
    ...
    coverage. Canonical main now understands migration 44's token-accounting
...
- **Steps:**
  ...
  - [ ] Extend the existing deploy preflight/cutover path and managed compatibility
    ...
    runtime artifact, it proves that artifact is v47 write-compatible; otherwise it
  ...
  - [ ] Document receipt inspection, quarantine/tombstone meaning, replay veto,
    ...
    downgrade to be fully v47 write-compatible or drain/read-only with all new
