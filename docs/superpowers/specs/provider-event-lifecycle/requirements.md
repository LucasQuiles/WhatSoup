...
**Schema allocation:** current canonical schema is migration 57; bounded terminal recovery/canonical `not_sent` is forward migration 58; the provider-event lifecycle ledger is migration 59. Migrations 50 and 51 are consumed by metadata-only durability evidence, migration 52 by outbound ambiguity-episode timing, migration 53 by outbound quarantine disposition/retirement receipts, migration 54 by the completed-delivery identity-admission ledger, migration 55 by typed online enrichment-cycle receipts, migration 56 by the inbound_events processing-status CHECK constraint (#2250), and migration 57 by the capability-obligation replay ledger, so the still-unpublished forward allocations move to migrations 58 and 59.
...
| AMD-061 | applied | schema-allocation-correction | CON-002, CON-005, DES-003, DES-008, DES-009 | Shifted the current canonical schema to 57, bounded terminal recovery/canonical `not_sent` to forward migration 58, and the provider-event lifecycle ledger/activation marker to 59, superseding the allocation portions of AMD-060 | The capability-obligation replay ledger (obligations, audit events, attestations, drain approvals, execution receipts) consumed migration 57; shifting the still-unpublished forward allocations preserves immutable migration history and keeps provider lifecycle inactive until its dedicated migration 59 | TSK-001, TSK-003, TSK-008, TSK-010 | coordinator | 2026-08-12T00:00Z |
