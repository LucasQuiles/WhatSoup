...
**Schema allocation:** current canonical schema is migration 59; bounded terminal recovery/canonical `not_sent` is forward migration 60; the provider-event lifecycle ledger is migration 61. Migrations 50 and 51 are consumed by metadata-only durability evidence, migration 52 by outbound ambiguity-episode timing, migration 53 by outbound quarantine disposition/retirement receipts, migration 54 by the completed-delivery identity-admission ledger, migration 55 by typed online enrichment-cycle receipts, migration 56 by the inbound_events processing-status CHECK constraint (#2250), migration 57 by the durable trigger-occurrence ledger (#2566), migration 58 by the capability-obligation replay ledger, and migration 59 by the capability-obligation audit hotfix (execution reservations + creation-reason honesty rebuild), so the still-unpublished forward allocations move to migrations 60 and 61.
...
- **Acceptance criteria:**
  ...
  - **CON-002.AC-06:** Before lifecycle runtime activation, canonical terminal
    ...
    singleton-set proof. Migration 60 permits aggregate `not_sent` only for
  ...
  - **CON-002.AC-07:** Migration 61 replaces the singleton seal with immutable fields on
...
| AMD-063 | applied | schema-allocation-correction | CON-002, CON-005, DES-003, DES-008, DES-009 | Shifted the current canonical schema to 59, bounded terminal recovery/canonical `not_sent` to forward migration 60, and the provider-event lifecycle ledger/activation marker to 61, superseding the allocation portions of AMD-062 | The capability-obligation post-merge-audit hotfix (durable execution reservations + creation-reason honesty rebuild) consumed migration 59; shifting the still-unpublished forward allocations preserves immutable migration history and keeps provider lifecycle inactive until its dedicated migration 61 | TSK-001, TSK-003, TSK-008, TSK-010 | coordinator | 2026-08-14T18:30Z |
