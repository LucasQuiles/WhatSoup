...
**Schema allocation:** current canonical schema is migration 60; bounded terminal recovery/canonical `not_sent` is forward migration 61; the provider-event lifecycle ledger is migration 62. Migrations 50 and 51 are consumed by metadata-only durability evidence, migration 52 by outbound ambiguity-episode timing, migration 53 by outbound quarantine disposition/retirement receipts, migration 54 by the completed-delivery identity-admission ledger, migration 55 by typed online enrichment-cycle receipts, migration 56 by the inbound_events processing-status CHECK constraint (#2250), migration 57 by the durable trigger-occurrence ledger (#2566), migration 58 by the capability-obligation replay ledger, migration 59 by the fact-export queue state machine and lease durability (#2567), and migration 60 by the capability-obligation audit hotfix (execution reservations + creation-reason honesty rebuild), so the still-unpublished forward allocations move to migrations 61 and 62.
...
- **Acceptance criteria:**
  ...
  - **CON-002.AC-06:** Before lifecycle runtime activation, canonical terminal
    ...
    singleton-set proof. Migration 61 permits aggregate `not_sent` only for
  ...
  - **CON-002.AC-07:** Migration 62 replaces the singleton seal with immutable fields on
...
| AMD-061 | applied | schema-allocation-correction | CON-002, CON-005, DES-003, DES-008, DES-009 | Shifted the current canonical schema to 57, bounded terminal recovery/canonical `not_sent` to forward migration 58, and the provider-event lifecycle ledger/activation marker to 59, superseding the allocation portions of AMD-060 | The durable trigger-occurrence ledger (`trigger_occurrences`, #2566) consumed migration 57; shifting the still-unpublished forward allocations preserves immutable migration history and keeps provider lifecycle inactive until its dedicated migration 59 | TSK-001, TSK-003, TSK-008, TSK-010 | coordinator | 2026-08-14T09:00Z |
| AMD-062 | applied | schema-allocation-correction | CON-002, CON-005, DES-003, DES-008, DES-009 | Shifted the current canonical schema to 58, bounded terminal recovery/canonical `not_sent` to forward migration 59, and the provider-event lifecycle ledger/activation marker to 60, superseding the allocation portions of AMD-061 | The capability-obligation replay ledger (obligations, audit events, attestations, drain approvals, execution receipts) consumed migration 58; shifting the still-unpublished forward allocations preserves immutable migration history and keeps provider lifecycle inactive until its dedicated migration 60 | TSK-001, TSK-003, TSK-008, TSK-010 | coordinator | 2026-08-14T09:30Z |
| AMD-063 | applied | schema-allocation-correction | CON-002, CON-005, DES-003, DES-008, DES-009 | Shifted the current canonical schema to 59, bounded terminal recovery/canonical `not_sent` to forward migration 60, and the provider-event lifecycle ledger/activation marker to 61, superseding the allocation portions of AMD-062 | The fact-export queue state machine and lease durability rebuild (`fact_export_queue`, #2567) consumed migration 59; shifting the still-unpublished forward allocations preserves immutable migration history and keeps provider lifecycle inactive until its dedicated migration 61 | TSK-001, TSK-003, TSK-008, TSK-010 | coordinator | 2026-08-14T19:00Z |
| AMD-064 | applied | schema-allocation-correction | CON-002, CON-005, DES-003, DES-008, DES-009 | Shifted the current canonical schema to 60, bounded terminal recovery/canonical `not_sent` to forward migration 61, and the provider-event lifecycle ledger/activation marker to 62, superseding the allocation portions of AMD-063 | The capability-obligation post-merge-audit hotfix (durable execution reservations + creation-reason honesty rebuild) consumed migration 60; shifting the still-unpublished forward allocations preserves immutable migration history and keeps provider lifecycle inactive until its dedicated migration 62 | TSK-001, TSK-003, TSK-008, TSK-010 | coordinator | 2026-08-14T19:15Z |
