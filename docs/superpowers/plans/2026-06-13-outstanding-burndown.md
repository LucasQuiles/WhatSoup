...
> - #804, #813, #816, #817, and #818 have since landed on main. #816 post-merge main CI on `218dfacd` finished 5/5 green; #817 post-merge main CI on `558730b0` finished 5/5 green; #818 post-merge main CI on `e1f07ffe` finished 5/5 green.
>
> **Do next:** continue the provider-outage hardening follow-up PRs for config/model consistency, primary-model entitlement probing, health turn capability, outbound dedupe, and release drift detection. Preserve/triage dirty parallel worktrees before cleanup. **Do not** treat the historical task checklist below as active work without first rechecking current main.
