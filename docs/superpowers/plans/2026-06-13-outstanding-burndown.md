...
| Open PR #816: provider-failure classification + terminal-error leak | Open and mergeable on branch `fix/provider-failure-taxonomy`; quality checks were still in progress during the 2026-06-13 inventory | Review after CI settles; do not merge until #804 local coverage gap is resolved or the PR dependency order is explicitly approved. |
