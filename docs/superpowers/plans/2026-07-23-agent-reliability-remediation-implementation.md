...
`edd46ddbf56e3beeb435c69c5abccb001ab09661`; this preserved the published
...
| Provider actor isolation and canary proof | `fix/agent-provider-actor-isolation-20260723` | #2128 | `fa1efaad0` |
| Queue-health truth | `fix/agent-queue-health-truth-20260723` | #2129 | `52021ef23` |
| Suspend and platform hardening | `fix/agent-suspend-platform-hardening-20260723` | #2130 | `4dbebe41a` |
...
A fifth reconciliation incorporated the upstream console semantic-token
foundation. Its only conflicts in this lane were generated work-index files;
regeneration resolved them. The change does not alter the agent runtime
contracts, and the updated console gates validate the combined token surface.
