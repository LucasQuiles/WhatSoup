...
| `docs/superpowers/plans/2026-07-20-bot-errors-proof-lifecycle.md` | PRIVATE-ARCHIVE | Internal proof-driven incident lifecycle implementation plan; retained in the repository but excluded from public publication by default. |
| `docs/superpowers/plans/2026-07-20-bot-errors-supervision-and-stress.md` | PRIVATE-ARCHIVE | Internal incident supervision, fault injection, and stress implementation plan; retained in the repository but excluded from public publication by default. |
| `docs/superpowers/plans/2026-07-20-inline-proposal-admission-and-cleanup.md` | PRIVATE-ARCHIVE | Internal inline proposal admission, idempotency, and reversible cleanup implementation plan; retained in the repository but excluded from public publication by default. |
| `docs/superpowers/plans/2026-07-21-watchdog-target-parity.md` | PRIVATE-ARCHIVE | Internal watchdog target-parity remediation plan; retained in the repository but excluded from public publication by default. |
...
| `docs/superpowers/specs/2026-07-20-durable-incident-remediation-protocol-design.md` | PRIVATE-ARCHIVE | Internal incident remediation, durability, cleanup, and rollout design; retained in the repository but excluded from public publication by default. |
