...
- GitHub issue queue has one open item as of 2026-05-12 09:43Z: `#405` tracks multibyte malformed-credential hardening for token comparisons. Earlier `#404` was closed as a false-positive after a fresh `/test-integrity` scan on `origin/main`.
...
- Ready-for-review PRs excluding this registry refresh: `#408` as of 2026-05-12 09:46Z.
- Draft PRs remain separate from the ready queue: `#256`, `#271`, `#272`, `#281`, `#286`, `#293`, `#297`, `#369`, `#372`, `#375`, `#379`, `#380`, `#386`, `#394`, `#398`, `#400`, `#403`, and `#406`.
