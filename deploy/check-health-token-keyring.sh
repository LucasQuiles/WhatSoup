...
# tokens.env EnvironmentFile line AND the wrapper export at deploy/whatsoup:174-182
...
if keyring_present "$SERVICE" "$INSTANCE"; then
  ...
  echo "     2. Wrapper export at deploy/whatsoup:174-182 (WHATSOUP_HEALTH_TOKEN)"
